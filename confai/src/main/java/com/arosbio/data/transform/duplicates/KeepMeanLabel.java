...
public class KeepMeanLabel implements DuplicatesResolverTransformer {
	
	public static final String DESCRIPTION = "For regression problems - use the mean of the duplicate records.";

	public static final String NAME = "KeepMeanLabel";

	private static final Logger LOGGER = LoggerFactory.getLogger(KeepMeanLabel.class);
	...
	@Override
	public KeepMeanLabel transformInPlace(boolean inPlace) {
		this.inPlace = inPlace;
		return this;
	}
	
	public KeepMeanLabel clone() {
		return new KeepMeanLabel();
	}
	...
	@Override
	public KeepMeanLabel fit(Collection<DataRecord> data) {
		return this;
	}
	...
	/**
	 * Performs the transformation in place (i.e. alters the SubSet)
	 */
	@Override
