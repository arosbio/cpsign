...
public class KeepLastRecord implements DuplicatesResolverTransformer {
	
	public static final String DESCRIPTION = "Keeps the last record encountered in the input (e.g. when newer data from newer experiments are assumed to be better than older data)";
	public static final String NAME = "KeepLastRecord";

	private static final Logger LOGGER = LoggerFactory.getLogger(KeepLastRecord.class);
	...
	@Override
	public KeepLastRecord transformInPlace(boolean inPlace) {
		this.inPlace = inPlace;
		return this;
	}
	
	public KeepLastRecord clone() {
		return new KeepLastRecord();
	}
	...
	@Override
	public KeepLastRecord fit(Collection<DataRecord> data) {
		return this;
	}
