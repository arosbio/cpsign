...
public class PositiveDistanceToHyperplaneNCM implements NCMMondrianClassification {

	private static final Logger LOGGER = LoggerFactory.getLogger(PositiveDistanceToHyperplaneNCM.class);
	private static final Version VERSION = new Version(1, 0, 0);
	public final static String IDENTIFIER="PositiveDistanceToHyperplane";
	public final static int ID = 12;
	public final static String DESCRIPTION = "Nonconformity score for classification, requing an SVC algorithm, using the positive distance to the decision hyperplane.";
	...
	public PositiveDistanceToHyperplaneNCM() {}

	public PositiveDistanceToHyperplaneNCM(SVC svm) {
		this.svm = svm;
	}

	@Override
	public PositiveDistanceToHyperplaneNCM clone() {
		if (svm != null)
			return new PositiveDistanceToHyperplaneNCM(svm.clone());
		return new PositiveDistanceToHyperplaneNCM();
	}
	...
	public void setModel(Classifier svm) throws IllegalArgumentException {
		if (svm instanceof SVC)
			...
			throw new IllegalArgumentException("PositiveDistanceToHyperplane NCM requires a SVM model");
	}
	...
	public Map<Integer,Double> calculateNCS(FeatureVector example) 
		...
		// Use the signed distance to the hyperplane - longer => more nonconforming 
